...
// Native video timing on a CLK_VIDEO/2 sample grid, 859/865 samples per line (NTSC/PAL)
...
always @* begin
	...
	MODE_480I: begin
		...
		V_BP     = field ? 9'd10 : 9'd9;     // 525 total lines: 263/262
	end
	...
	MODE_PAL: begin
		...
		V_ACTIVE = 9'd288;  V_FP = 9'd11; V_SYNC = 5'd3; V_BP = 9'd10;
	end
	...
	MODE_576I: begin
		...
		V_BP     = field ? 9'd12 : 9'd11;    // 625 total lines: 313/312
	end

	default: begin // MODE_NTSC
		// 320 source pixels are doubled to 640 active timing samples.
		H_ACTIVE = 10'd640; H_FP = 10'd56; H_SYNC = 7'd62; H_BP = 10'd101;
		V_ACTIVE = 9'd240;  V_FP = 9'd8;  V_SYNC = 5'd3; V_BP = 9'd11;
	end
	endcase
end
...
wire [9:0] V_TOTAL_WIDE = {1'b0, V_ACTIVE}
                          + {1'b0, V_FP}
                          + {5'd0, V_SYNC}
                          + {1'b0, V_BP};
wire [8:0] V_TOTAL = V_TOTAL_WIDE[8:0];
